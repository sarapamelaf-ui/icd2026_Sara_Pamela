...
# Organizando dados com pivot_longer() ------------------------------------# Arquivo: 03-dados-organizados-joins.R
...
# exemplo 2
#tranforma desempenho para o formato longo
...
clientes
 ...
 # combina vendase produtos usando left_join() 
...
#combina vendas produtos com clientes usando left_join()
...
# Desafio: combine as 3 tabelas com um unico pipeline usando left_join()
# e veja o resultado usando a função  view()

relatorio_vendas <-  vendas |> 
  left_join(produtos, by = "codigo_produto") |> 
  left_join(clientes, by = "id_cliente")

#visualiza o objeto np Rstudio
